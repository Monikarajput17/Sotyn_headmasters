...
// and pattern with my selected things, dynamic"). Port of server/lib/emailEvents.js.
//
// Each event declares:
...
export interface EmailEventDef {
  label: string; group: string; live: boolean; vars: string[];
  people: Array<{ key: string; label: string }>; fields: string[];
}

export const EVENTS: Record<string, EmailEventDef> = {
  "indent.raised": {
    label: "Indent raised",
    group: "Indent",
    live: true,
...
// a live record.
export const SAMPLE_CONTEXT: Record<string, any> = {
  indent_no: "IND-0123",
  site: "HERO HOMES",
  ...
  total_loss: "45,000",
  date: "2026-06-03",
  // Payments & bills (amount shared with the indent sample above)
  party: "ABC Traders",
