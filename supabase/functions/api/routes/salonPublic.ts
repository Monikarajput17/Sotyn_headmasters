...
// Ported from server/routes/salonPublic.js (Phase-3 Postgres version).
...
router.post('/book', async (req, res) => {
  ...
  const serviceIds: any[] = Array.isArray(b.service_ids) ? b.service_ids.slice(0, 10) : [];
  ...
  try {
    ...
    console.error('[salon public book] failed:', (e as Error).message);
